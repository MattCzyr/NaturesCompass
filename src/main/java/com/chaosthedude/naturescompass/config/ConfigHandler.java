...
public class ConfigHandler {
	...
	public static class General {
		...
		General(ModConfigSpec.Builder builder) {
			...
			desc = "The default number of XP levels consumed when searching for a biome. Individual biomes can be configured via xpLevelOverrides.";
 			defaultXpLevels = builder.comment(desc).defineInRange("defaultXpLevels", 0, 0, 3);
			
			desc = "A list of biome-specific XP level costs that override defaultXpLevels, specified as comma-separated \"biome_id,num_levels\" pairs. Biomes not listed here use defaultXpLevels. Max of 3 levels. The wildcard character * can be used to match any number of characters, and ? can be used to match one character. Ex: [\"minecraft:deep_dark,3\", \"minecraft:end*,2\", \"minecraft:*caves,3\"]";
