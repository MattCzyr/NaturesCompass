...
public class ConfigHandler {
	...
	public static void init() {
		...
		comment = "The maximum new chunks that can be generated during a single search.";
		maxChunksGenerated = loadInt(Configuration.CATEGORY_GENERAL, "naturescompass.maxChunksGenerated", comment, maxChunksGenerated);
