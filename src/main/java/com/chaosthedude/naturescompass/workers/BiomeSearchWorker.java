...
public class BiomeSearchWorker implements WorldWorkerManager.IWorker {
	...
	public boolean doWork() {
		...
		if (hasWork()) {
			...
			for (int y : yValues) {
				...
				final Optional<Identifier> optionalBiomeAtPosID = BiomeUtils.getIdForBiome(world, biomeAtPos);
	...
	private void checkConnections() {
		...
		for (int y : yValues) {
			...
			final Optional<Identifier> checkBiomeID = BiomeUtils.getIdForBiome(world, biomeAtCheck);
