...
public class NaturesCompassScreen extends Screen {
	...
	private void setupButtons() {
		...
		sortByButton = addButton(new TransparentButton(10, 90, 110, 20, new LiteralText(I18n.translate("string.naturescompass.sortBy") + ": " + sortingCategory.getLocalizedName()), (onPress) -> {
		...
		infoButton = addButton(new TransparentButton(10, 65, 110, 20, new TranslatableText("string.naturescompass.info"), (onPress) -> {
			if (selectionList.hasSelection()) {
				selectionList.getSelected().viewInfo();
			}
		}));
		startSearchButton = addButton(new TransparentButton(10, 40, 110, 20, new TranslatableText("string.naturescompass.startSearch"), (onPress) -> {
			if (selectionList.hasSelection()) {
				selectionList.getSelected().searchForBiome();
			}
		}));
		teleportButton = addButton(new TransparentButton(width - 120, 10, 110, 20, new TranslatableText("string.naturescompass.teleport"), (onPress) -> {
			teleport();
		}));
