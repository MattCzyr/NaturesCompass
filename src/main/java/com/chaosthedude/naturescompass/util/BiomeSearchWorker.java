...
public class BiomeSearchWorker implements WorldWorkerManager.IWorker {
	...
	// Counts sample, sets up direction for next sample, and updates compass radius. Called at the
	// end of a sample if a match is not found and at the end of the connections check if the
